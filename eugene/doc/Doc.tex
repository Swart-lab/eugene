...
\item \texttt{EuGene.CodonTable}: filename of the file which contains 
the codon table. The path is relative to EUGENEDIR. 
...
\section{EuGène prokaryote mode}
 
Since version 4, EuGène is able to predict genes for prokaryote genomes and operon structure.
Activate this mode by puting 'Prokaryote' to the \texttt{EuGene.mode} attributes
or by using the flag -P in the command line.
