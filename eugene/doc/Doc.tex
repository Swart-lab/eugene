...
\newcommand{\EuGenie}{\textsc{EuGène}}
...
\author{Philipe Bardou, Marie-Josée Cros, Sylvain Foissac, Annick Moisan,Thomas Schiex\\Biometry and AI Dept.\\ INRA Toulouse\\France}
...
started on sam déc 7 13:44:35 CET 2002
...
finished on sam déc 7 13:47:14 CET 2002
\end{Verbatim}
...
name is \texttt{eugene} and accordingly the parameter file is
...
After updating the parameter file eugene.par (which sensors to use, ...), the software is lauched with the usual command line specifying in argument the sequences to consider. At the end, the software creates a new parameter file called \texttt{eugene.<date>.OPTI.par} (for example, \texttt{eugene.30Sep2003.OPTI.par}) with the new value for the optimized parameters.\\
